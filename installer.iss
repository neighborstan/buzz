...
Source: "dist\Buzz\_internal\libssl-3*.dll"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "dist\Buzz\_internal\libcrypto-3*.dll"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
